...
echo "   Explorer (proxy):  http://localhost:7101"
echo "   API:               http://localhost:7101/api/v2"
echo "   Frontend (direct): http://localhost:7401"
echo "   Backend (direct):  http://localhost:7701/api/v2"
echo ""
