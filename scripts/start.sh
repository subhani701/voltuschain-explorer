...
echo "   Explorer (proxy):  http://localhost:39001"
echo "   API:               http://localhost:39001/api/v2"
echo "   Frontend (direct): http://localhost:41001"
echo "   Backend (direct):  http://localhost:43001/api/v2"
echo ""
